...
// Default message, the Gweno welcome / announcement.
const DEFAULT_SUBJECT = 'Welcome to Gweno';
...
function bodyToHtml(body, name) {
  ...
  return `
    <div style="font-family:Inter,Arial,sans-serif;font-size:15px;color:#111827;line-height:1.6;max-width:600px;">
      ${intro}${paragraphs}
      <p style="margin-top:18px;color:#1f2937;font-weight:600;">— The Gweno Team</p>
    </div>`;
}
...
export default async function handler(req, res) {
  ...
  const from    = `"Gweno" <${process.env.SMTP_USER}>`;
