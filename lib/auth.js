...
export async function bulkWithdrawalQuote(declaredFees, context) {
  ...
  // Local dev fallback (no live FX): full USD 51 at an approximate rate, minus the declared credits.
  const rate = 135, convertedKes = Math.round(51 * rate), deductionKes = n * 650;
  return { success: true, eligible: true, balance: 0, feeUsd: 51, rate, rateLive: false,
