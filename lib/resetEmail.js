...
export function buildResetEmail({ userName, resetUrl }) {
  ...
  const subject = 'Reset your Gweno Hub password';
  const text = `Hello ${name},

We received a request to reset your Gweno Hub password.
...
Gweno Hub Team`;
  ...
  const html = `
    <div style="font-family:Inter,Arial,sans-serif;font-size:15px;color:#111827;line-height:1.6;max-width:600px;">
      ...
      <p>We received a request to reset your <strong>Gweno Hub</strong> password.</p>
      ...
      <p style="color:#111827;font-weight:700;margin-top:14px;">Gweno Hub Team</p>
    </div>`;
