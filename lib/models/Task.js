 ...
 * Budgets follow the README's KES 1,200 to 4,600 range.
 *
...
const tasks = [
  {
    ...
    description:
      'Draft 20 concise, SEO-friendly product descriptions (80 to 120 words each) for a Nairobi-based fashion boutique\'s online store. Tone should be warm and locally relevant; avoid generic filler copy.',
    category: 'Writing',
    questions: [
  ...
  },
  {
    ...
    description:
      'Conduct desk research and compile a 5 to 7 page report on how small businesses in Kisumu use mobile money (M-Pesa, Airtel Money) for daily operations, including adoption barriers and preferred features.',
    category: 'Research',
    questions: [
  ...
  },
  {
    ...
    description:
      'Write 10 original blog articles (600 to 800 words each) on personal finance topics relevant to young Kenyan professionals, budgeting, saving via chamas, investing basics, and avoiding debt traps.',
    category: 'Writing',
    questions: [
