...
const extraTasks = [
  {
    ...
    description:
      'Write 5 short, persuasive product descriptions (40–60 words each) for a Nairobi online thrift (mitumba) store selling a jacket, dress, pair of sneakers, handbag, and jeans. Each should highlight the condition, style, and a reason to buy now, in a friendly, trendy tone aimed at young shoppers.',
    questions: [
      'Can you write short, catchy product copy?',
      'Can you keep each description within 40–60 words?',
  ...
  },
  {
    ...
    description:
      'Write 3 detailed blog-post outlines (a heading plus 5–6 bullet subpoints each) for a Kenyan personal-finance site. Topics: budgeting on an irregular income, starting an emergency fund, and avoiding mobile-loan traps. Make them practical and locally relevant.',
    questions: [
  ...
  },
  {
    ...
    description:
      'Design a 5-lesson beginner learning plan for Microsoft Excel aimed at job-seekers. For each lesson give the objective, 3–4 topics covered, a short hands-on exercise, and how success is measured. Progress from navigation to formulas and simple charts.',
    questions: [
  ...
  },
  {
    ...
    description:
      'Design a 5-module beginner course outline on digital marketing for small-business owners. For each module give the learning objectives, 4–5 lesson topics, a practical assignment, and the skills gained. Progress from fundamentals to running a first campaign.',
    questions: [
