...
const tier1 = [
  ...
  },
  {
    ...
    questions: [
      ...
      'Can you deliver within 51 minutes?',
    ],
    category: 'Marketing',
    payment: 1300,
  },
...
const extraTasks = [
  ...
  {
    title: 'Transcribe a 51-Minute Meeting and Extract Action Items',
    description:
      'Transcribe a 51-minute English team meeting (3 speakers) into clean, speaker-labelled text, then extract a list of decisions and action items with owners. Keep all figures and commitments accurate, and clearly separate the transcript from the summary.',
    questions: [
...
// ── CATEGORY POOL, Data Entry · Design · Translation · Survey · Marketing ────
// Guarantees every one of these categories always has a spread of varied,
// non-duplicate tasks across difficulty levels and rewards.
const categoryTasks = [
  // ── Data Entry ──
  { category: 'Data Entry', payment: 1400, dueInDays: 2, title: 'Enter 50 Product Rows into a Spreadsheet from Photos',
    description: 'Type 50 products (name, price, size, colour, stock) into a provided spreadsheet template from clear product photos. Keep formatting consistent and double-check every price and quantity.',
    questions: ['Are you fast and accurate with data entry?', 'Can you follow a fixed column format?'] },
  { category: 'Data Entry', payment: 1650, dueInDays: 2, title: 'Extract 40 Business Cards into a CSV',
    description: 'Read 40 business-card images and enter name, company, title, phone, and email into a clean CSV. Verify each email format and phone-number length before submitting.',
    questions: ['Can you transcribe details accurately?', 'Are you careful with emails and phone numbers?'] },
  { category: 'Data Entry', payment: 1900, dueInDays: 3, title: 'Clean and Deduplicate a 300-Row Contact List',
    description: 'Clean a messy 300-row contact list: remove duplicates, fix inconsistent capitalisation, standardise phone formats, and flag rows with missing data. Return a tidy, deduplicated sheet plus a note of what you changed.',
    questions: ['Are you comfortable cleaning spreadsheet data?', 'Can you spot and merge duplicates reliably?'] },
  { category: 'Data Entry', payment: 2100, dueInDays: 3, title: 'Update 120 Inventory Records with New Prices',
    description: 'Apply a supplier price list to 120 inventory rows: update cost and selling price, recalculate margin with a simple formula, and highlight any item now below a set margin. Accuracy of every figure is essential.',
    questions: ['Can you update records without errors?', 'Are you comfortable with basic spreadsheet formulas?'] },
  { category: 'Data Entry', payment: 2400, dueInDays: 4, title: 'Convert a 6-Page PDF Catalogue into a Structured Spreadsheet',
    description: 'Extract every item from a 6-page PDF catalogue into a structured spreadsheet (category, item, spec, price). Preserve the catalogue order, keep categories grouped, and ensure no item is missed.',
    questions: ['Can you convert PDFs into clean structured data?', 'Are you thorough and detail-oriented?'] },
  { category: 'Data Entry', payment: 2650, dueInDays: 4, title: 'Type Up 15 Handwritten Survey Forms into a Spreadsheet',
    description: 'Enter the responses from 15 scanned handwritten survey forms into one spreadsheet, one row per respondent. Interpret unclear handwriting sensibly, keep answer codes consistent, and flag anything unreadable.',
    questions: ['Can you read and enter handwritten data accurately?', 'Can you keep coding consistent across rows?'] },
  { category: 'Data Entry', payment: 3000, dueInDays: 5, title: 'Categorise and Tag 200 Expense Transactions',
    description: 'Go through 200 bank/M-Pesa transaction lines and assign each a category (transport, supplies, rent, utilities, etc.) and a tag (business/personal). Keep the category list tight and consistent, and total each category at the end.',
    questions: ['Can you classify transactions consistently?', 'Are you comfortable summarising by category?'] },

  // ── Design ──
  { category: 'Design', payment: 1700, dueInDays: 3, title: 'Design a 3-Size WhatsApp Status Banner Set',
    description: 'Create a matching set of 3 WhatsApp status banners (announcing a weekend promo) in the correct vertical size, with a bold headline, the offer, and a call to action. Keep the brand colours and style consistent across all three.',
    questions: ['Can you design clean promo graphics?', 'Can you keep a consistent style across a set?'] },
  { category: 'Design', payment: 1900, dueInDays: 3, title: 'Design a Business Card Layout (Front and Back)',
    description: 'Design a clean, modern business card (front and back) for a consultant: logo/name area, title, phone, email, and a subtle brand accent. Deliver a print-ready layout at the standard card size with sensible margins.',
    questions: ['Can you design professional print layouts?', 'Do you understand print margins and bleed?'] },
  { category: 'Design', payment: 2200, dueInDays: 4, title: 'Create a 3-Slide Instagram Carousel Layout for a Sale',
    description: 'Design a 3-slide Instagram carousel announcing a flash sale: slide 1 hook, slide 2 the offer/products, slide 3 the call to action. Keep a consistent grid, readable type, and a scroll-stopping first slide.',
    questions: ['Are you familiar with Instagram carousel design?', 'Can you make a strong first slide?'] },
  { category: 'Design', payment: 2000, dueInDays: 4, title: 'Produce a Simple Product-Label Mockup',
    description: 'Design a simple, attractive product label (e.g., for a honey jar): product name, weight, a short tagline, and space for ingredients. Keep it clean, legible, and appropriate for a small food brand.',
    questions: ['Can you design clear product packaging?', 'Can you balance information and aesthetics?'] },
  { category: 'Design', payment: 2400, dueInDays: 5, title: 'Design a Facebook Cover and Profile Set for a Brand',
    description: 'Create a matching Facebook cover image and profile picture for a fitness brand, at the correct dimensions, with the logo, a tagline, and consistent colours. Ensure key elements stay clear of Facebook UI crop areas.',
    questions: ['Do you know the correct social image sizes?', 'Can you keep a brand look consistent?'] },
  { category: 'Design', payment: 2900, dueInDays: 5, title: 'Design a One-Page A5 Event Flyer',
    description: 'Design a striking A5 event flyer for a local concert: event name, date/venue, lineup, ticket info, and a QR-code placeholder. Create a clear visual hierarchy and an eye-catching but readable layout.',
    questions: ['Can you design attention-grabbing flyers?', 'Can you organise information with clear hierarchy?'] },
  { category: 'Design', payment: 3200, dueInDays: 6, title: 'Design a Café Menu Card',
    description: 'Design a clean, appetising one-page café menu card with sections (hot drinks, cold drinks, snacks, meals), prices, and a warm brand feel. Keep it easy to scan and print-ready at A4.',
    questions: ['Can you design well-structured menus?', 'Can you make layouts print-ready?'] },

  // ── Translation ──
  { category: 'Translation', payment: 1500, dueInDays: 2, title: 'Translate 15 SMS Templates English → Swahili',
    description: 'Translate 15 short marketing/notification SMS templates from English into natural, everyday Swahili, keeping each under 160 characters and preserving any placeholders (name, date, amount).',
    questions: ['Are you fluent in written Swahili?', 'Can you keep translations short and natural?'] },
  { category: 'Translation', payment: 1600, dueInDays: 2, title: 'Translate 10 App UI Strings English → French',
    description: 'Translate 10 mobile-app interface strings (buttons, labels, error messages) from English into concise, correct French. Keep UI terms standard and lengths short enough to fit small buttons.',
    questions: ['Are you fluent in written French?', 'Are you familiar with UI/app terminology?'] },
  { category: 'Translation', payment: 1800, dueInDays: 3, title: 'Translate a 300-Word Blog Post English → Swahili',
    description: 'Translate a 300-word English blog post into fluent, natural Swahili that reads as if originally written in it, keeping the tone and meaning intact and localising idioms sensibly.',
    questions: ['Can you translate naturally, not word-for-word?', 'Is your written Swahili strong?'] },
  { category: 'Translation', payment: 2000, dueInDays: 3, title: 'Translate a Restaurant Menu English → German',
    description: 'Translate a full restaurant menu (about 30 items with short descriptions) from English into appetising, correct German. Use proper culinary terms and keep descriptions concise and menu-friendly.',
    questions: ['Are you fluent in written German?', 'Can you translate food terms accurately?'] },
  { category: 'Translation', payment: 2200, dueInDays: 4, title: 'Translate 8 Customer FAQs English → Portuguese',
    description: 'Translate 8 customer-support FAQ questions and answers from English into clear, polite Brazilian Portuguese, keeping a friendly support tone and any product names unchanged.',
    questions: ['Are you fluent in Portuguese?', 'Can you keep a warm support tone?'] },
  { category: 'Translation', payment: 2600, dueInDays: 4, title: 'Translate a 250-Word Product Page English → Arabic',
    description: 'Translate a 250-word e-commerce product page from English into fluent Modern Standard Arabic, preserving persuasive tone and formatting (headings, bullet points), and reading naturally right-to-left.',
    questions: ['Are you fluent in written Arabic?', 'Can you preserve marketing tone in translation?'] },
  { category: 'Translation', payment: 3000, dueInDays: 5, title: 'Translate a 400-Word Press Release English → Spanish',
    description: 'Translate a 400-word corporate press release from English into professional Latin American Spanish, keeping the formal register, accurate figures, and the exact company/product names.',
    questions: ['Are you fluent in professional Spanish?', 'Can you keep a formal, accurate register?'] },

  // ── Survey ──
  { category: 'Survey', payment: 1500, dueInDays: 2, title: 'Write a 5-Question Product-Feedback Survey',
    description: 'Write a short 5-question product-feedback survey for an online store: mix rating scales with one open-ended question, covering quality, value, delivery, and likelihood to reorder. Keep wording neutral and unbiased.',
    questions: ['Can you write clear, unbiased survey questions?', 'Do you understand basic feedback goals?'] },
  { category: 'Survey', payment: 1700, dueInDays: 2, title: 'Build a 5-Question Post-Purchase Survey',
    description: 'Design a 5-question post-purchase survey to send after checkout, covering ease of ordering, delivery speed, product match to description, support, and an NPS-style recommend question. Keep it quick to complete.',
    questions: ['Can you design short, effective surveys?', 'Are you familiar with post-purchase feedback?'] },
  { category: 'Survey', payment: 1900, dueInDays: 3, title: 'Create an 8-Question Event-Feedback Form',
    description: 'Create an 8-question feedback form for attendees after a community event: venue, content, speakers, organisation, and open comments. Use a mix of 1–5 scales and short-answer, with neutral, easy wording.',
    questions: ['Can you structure balanced feedback forms?', 'Can you keep questions clear and short?'] },
  { category: 'Survey', payment: 2000, dueInDays: 3, title: 'Draft a 6-Question NPS Plus Follow-Up Survey',
    description: 'Draft a 6-question survey built around a Net Promoter Score question, with sensible follow-ups that branch on high vs low scores to learn the reason. Keep it concise and unbiased.',
    questions: ['Are you familiar with NPS methodology?', 'Can you write non-leading follow-up questions?'] },
  { category: 'Survey', payment: 2400, dueInDays: 4, title: 'Design a 10-Question Employee-Engagement Survey',
    description: 'Design a 10-question employee-engagement survey covering role clarity, workload, recognition, management support, growth, and belonging. Use 1–5 scales plus 2 open questions, keeping items neutral and anonymous-friendly.',
    questions: ['Can you design professional HR surveys?', 'Do you understand engagement drivers?'] },
  { category: 'Survey', payment: 2600, dueInDays: 4, title: 'Design a 7-Question App Usability Survey',
    description: 'Write a 7-question usability survey for a mobile app, covering ease of navigation, speed, clarity, task success, and satisfaction, with a mix of rating scales and one open question. Keep it short and unbiased.',
    questions: ['Are you familiar with usability/UX surveys?', 'Can you write clear, focused questions?'] },
  { category: 'Survey', payment: 3100, dueInDays: 5, title: 'Create a 12-Question Market-Research Questionnaire',
    description: 'Build a 12-question market-research questionnaire for a new snack product: demographics, buying habits, price sensitivity, preferences, and purchase intent. Use appropriate question types and avoid leading wording throughout.',
    questions: ['Can you design robust research questionnaires?', 'Do you understand price-sensitivity questions?'] },

  // ── Marketing ──
  { category: 'Marketing', payment: 1400, dueInDays: 2, title: 'Create 10 Hashtag Sets for a Fashion Page',
    description: 'Create 10 curated hashtag sets (10–15 tags each) for a Kenyan fashion Instagram page, mixing broad, niche, and local tags. Group them by theme (outfits, sales, behind-the-scenes) so posts can pick the right set fast.',
    questions: ['Do you understand hashtag strategy?', 'Can you research relevant niche tags?'] },
  { category: 'Marketing', payment: 1600, dueInDays: 2, title: 'Write 5 TikTok Hook Lines for a Skincare Brand',
    description: 'Write 5 scroll-stopping first-line hooks (under 12 words each) for TikTok videos promoting a natural skincare brand. Each should spark curiosity or a bold claim that makes viewers stop and watch.',
    questions: ['Can you write punchy short-form hooks?', 'Are you familiar with TikTok content?'] },
  { category: 'Marketing', payment: 1900, dueInDays: 3, title: 'Write a 150-Word Facebook Ad for a Bakery',
    description: 'Write a 150-word Facebook ad for a neighbourhood bakery promoting fresh daily bread and custom cakes. Include a hook, key benefits, social proof, and a clear call to action with an offer placeholder.',
    questions: ['Can you write persuasive ad copy?', 'Can you fit a full pitch into 150 words?'] },
  { category: 'Marketing', payment: 2300, dueInDays: 3, title: 'Write 4 Google Search Ad Variations for a Dentist',
    description: 'Write 4 Google Search ad variations for a dental clinic, each with 3 headlines (≤30 chars) and 2 descriptions (≤90 chars), highlighting different angles (pain relief, same-day, affordability, family care). Keep within character limits.',
    questions: ['Are you familiar with Google Ads formats?', 'Can you write within strict character limits?'] },
  { category: 'Marketing', payment: 2600, dueInDays: 4, title: 'Plan a 7-Day Content Calendar for a Salon',
    description: 'Plan a 7-day social content calendar for a hair salon: for each day give the platform, post idea, caption angle, a hashtag set, and best posting time. Balance promos, tips, transformations, and engagement posts.',
    questions: ['Can you plan a balanced content calendar?', 'Do you understand social scheduling?'] },
  { category: 'Marketing', payment: 2800, dueInDays: 4, title: 'Draft a 3-Email Welcome Sequence for a Gym',
    description: 'Draft a 3-email welcome sequence for new gym leads: email 1 welcome + free class, email 2 social proof + programs, email 3 offer + urgency. For each give subject, preview text, body (80–120 words), and CTA.',
    questions: ['Can you design conversion-focused email flows?', 'Can you write with a clear CTA?'] },
  { category: 'Marketing', payment: 3000, dueInDays: 5, title: 'Create a Referral-Program One-Pager for an App',
    description: 'Write a clear one-page referral-program explainer for a fintech app: how it works in 3 steps, the reward for referrer and friend, terms in plain English, and a motivating headline + CTA. Keep it simple and shareable.',
    questions: ['Can you explain a program simply and persuasively?', 'Can you structure a clean one-pager?'] },
];

// ── Build final TASKS array ──────────────────────────────────────────────────
let idCounter = 1;

const allTemplates = [...tier1, ...tier2, ...tier3, ...tier4, ...internationalTasks, ...extraTasks, ...categoryTasks];
