...
Thank you for being part of Business Hub.
...
Business Hub Team`;
  ...
  const html = `
    <div style="font-family:Inter,Arial,sans-serif;font-size:15px;color:#111827;line-height:1.6;max-width:600px;">
      ...
      <p>Thank you for being part of Business Hub.</p>
      <p style="color:#125C37;font-weight:700;margin-top:12px;">Business Hub Team</p>
    </div>`;
